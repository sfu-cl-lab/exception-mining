...
public class NormalityTests {
    ...
    public static String runNormalityTests(RectangularDataSet oldDataSet, ContinuousVariable variable)
    {
        ColtDataSet dataSet = new ColtDataSet((ColtDataSet)oldDataSet);
        ...
        //System.out.println(ksResults[1]);
        //System.out.println(ksResults[2]);
        //System.out.println(ksResults[3]);
        //System.out.println(ksResults[4]);
        //System.out.println(ksResults[5]);
        double displayableKAlphas[] = new double[5];
        displayableKAlphas[0] = Math.round(ksResults[1]*1000.0) / 1000.0;
        displayableKAlphas[1] = Math.round(ksResults[2]*1000.0) / 1000.0;
        displayableKAlphas[2] = Math.round(ksResults[3]*1000.0) / 1000.0;
        displayableKAlphas[3] = Math.round(ksResults[4]*1000.0) / 1000.0;
        displayableKAlphas[4] = Math.round(ksResults[5]*1000.0) / 1000.0;
        result += "\t" + displayableKAlphas[0] + "\t" + displayableKAlphas[1] + "\t" + displayableKAlphas[2] + "\t" + displayableKAlphas[3] + "\t" + displayableKAlphas[4] + "\n";
    ...
    public static double[] kolmogorovSmirnov(RectangularDataSet dataSet, ContinuousVariable variable)
    {
    ...
    public static double empiricalDistributionFunction(RectangularDataSet dataSet, Variable var, double x, int n)
    {
        double value = 0.0;
    ...
    public static void sortVariable(RectangularDataSet dataSet, Variable variable)
    {
        int columnIndex = dataSet.getColumn(variable);
     ...
     */
    public static double cramerVonMises(RectangularDataSet dataSet, ContinuousVariable variable)
    {
        int n = dataSet.getNumRows();
        int columnIndex = dataSet.getColumn(variable);
        Normal idealDistribution = getNormal(dataSet, variable);
    ...
    public static Normal getNormal(RectangularDataSet dataSet, Variable variable)
    {
    ...
    public static double[] normalParams(RectangularDataSet dataSet, Variable variable)
    {
        int columnIndex = dataSet.getColumn(variable);
        double mean = 0.0;
        double sd = 0.0;
