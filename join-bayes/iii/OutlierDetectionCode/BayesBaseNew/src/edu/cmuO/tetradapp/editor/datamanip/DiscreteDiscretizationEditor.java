 ...
 * @version $Revision: 5519 $ $Date: 2006-01-08 23:44:17 -0500 (Sun, 08 Jan
 *          2006) $
 */
class DiscreteDiscretizationEditor extends JPanel {
    ...
    public DiscreteDiscretizationEditor(DiscreteVariable variable) {
        ...
        this.numCategories = variable.getNumCategories();
...
//        b1.add(b2);
    ...
    public void setDiscretizationSpec(DiscreteDiscretizationSpec spec) {
        remapEditor.setDiscretizationSpec(spec);
    }
    ...
    final static class RemapEditor extends JComponent {
        ...
        private LinkedList<StringTextField> focusTraveralOrder =
