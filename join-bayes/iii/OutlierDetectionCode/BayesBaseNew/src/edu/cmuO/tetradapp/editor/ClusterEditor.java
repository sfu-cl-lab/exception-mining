 ...
 * @version $Revision: 6142 $ $Date: 2006-01-08 23:44:17 -0500 (Sun, 08 Jan
 *          2006) $
 */
final class ClusterEditor extends JPanel {
    ...
    private Box clusterDisplay() {
        ...
        SpinnerNumberModel spinnerNumberModel =
                new SpinnerNumberModel(clusters.getNumClusters(), 1, 100, 1);
    ...
    private void setNumDisplayClusters(int numClusters) {
        if (numClusters < 0) {
            int numStoredClusters = getClusters().getNumClusters();
