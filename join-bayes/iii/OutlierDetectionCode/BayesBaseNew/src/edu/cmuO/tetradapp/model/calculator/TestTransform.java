...
/**
 * @author Tyler Gibson
 * @version $Revision: 5546 $ $Date: 2006-01-09 13:18:07 -0500 (Mon, 09 Jan
 *          2006) $
 */
public final class TestTransform extends TestCase {
    ...
    public void testTransformWithNewColumnVariable(){
        ...
        RectangularDataSet data = new ColtDataSet(1, list);
    ...
    public void testSingleTransforms() {
        ...
        RectangularDataSet data = new ColtDataSet(2, list);
        ...
        RectangularDataSet copy = new ColtDataSet((ColtDataSet) data);
