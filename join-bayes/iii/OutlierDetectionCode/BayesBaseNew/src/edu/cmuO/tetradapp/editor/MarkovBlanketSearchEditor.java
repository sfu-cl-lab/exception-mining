 ...
 *
 * @author Tyler Gibson
 * @version $Revision: 5925 $ $Date: 2006-01-09 15:55:02 -0500 (Mon, 09 Jan
 *          2006) $
 */
    ...
    private void execute() {
        ...
        final WatchedProcess process = new WatchedProcess(owner) {
			...
			public void watch() {
                ...
                setLabel();
                RectangularDataSet modelForMarkovBlanket = algorithmRunner.getDataModelForMarkovBlanket();
