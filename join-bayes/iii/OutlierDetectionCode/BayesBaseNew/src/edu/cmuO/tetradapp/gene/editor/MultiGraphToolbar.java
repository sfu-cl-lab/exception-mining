 ...
 * @version $Revision: 4524 $ $Date: 2005-10-06 10:43:33 -0400 (Thu, 06 Oct
 *          2005) $
 */
public class MultiGraphToolbar extends JPanel
     ...
     */
    private MultiGraphWorkbench workbench;

    /**
     * Constructs a new Graph toolbar governing the modes of the given
     * GraphWorkbench.
     */
    public MultiGraphToolbar(MultiGraphWorkbench workbench) {
        ...
        // GMLI- causes nodes to be added every time the window gets the focus - addObserved.addFocusListener(focusListener);
        ...
        addObserved.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
                ...
                //setNodeType(GraphWorkbench.MEASURED_NODE);
                createNewNode();
            }
        });
        addDirectedEdge.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
                ...
                //                setEdgeMode(GraphWorkbench.FORBIDDEN_EDGE);
            }
        });
        ...
        addButton(addObserved, "variable", false);
        group.remove(
                addObserved); // adds factors immediately upon clicking- no need to have button stay selected
    ...
    /**
     * Convenience method to set the mode of the editor.  Placed
     * here because Java will not allow access to the variable
     * 'editor' from inner classes.
     */
    ...
    private void cleanup() {
        workbench.setModelGraph(workbench.getModelGraph());
    }
}
