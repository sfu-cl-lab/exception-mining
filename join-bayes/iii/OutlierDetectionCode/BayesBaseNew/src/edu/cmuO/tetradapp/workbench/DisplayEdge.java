 ...
 * @version $Revision: 5177 $ $Date: 2005-10-06 10:43:33 -0400 (Thu, 06 Oct
 *          2005) $
 */
public class DisplayEdge extends JComponent implements IDisplayEdge {
     ...
     */
    public static final Color LINE_COLOR = new Color(78, 117, 175);
//    public static final Color LINE_COLOR = new Color(99, 101, 188);
//    public static final Color LINE_COLOR = new Color(0, 4, 255);
//    public static final Color LINE_COLOR = new Color(52, 55, 217);

    /**
     * The color that selected edges will be drawn in.
     */
    public static final Color SELECTED_COLOR = new Color(221, 66, 32);
//    public static final Color SELECTED_COLOR = new Color(255, 151, 0);
//    public static final Color SELECTED_COLOR = new Color(255, 123, 0);
    ...
    /**
     * The current mode of the edge--HALF_ANCHORED, ANCHORED_UNSELECTED, or
     * ANCHORED_SELECTED.
     */
    private int mode;
    ...
    /**
     * Returns the current track point for the edge.  When a new edge is being
    ...
    protected final PointPair calculateEdge(DisplayNode comp, Point p) {
        Rectangle r = ((Component) comp).getBounds();
