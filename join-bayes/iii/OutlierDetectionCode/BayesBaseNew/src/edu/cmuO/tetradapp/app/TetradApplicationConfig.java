...
public class TetradApplicationConfig {
    ...
    private static class DefaultNodeConfig implements SessionNodeConfig {
        ...
        @Override
		public ModelChooser getModelChooserInstance(String nodeName) {
    ...
    private static class DefaultModelConfig implements SessionNodeModelConfig {
		...
		public JPanel getEditorInstance(Object[] arguments) {
            ...
            if (constructor == null) {
                throw new NullPointerException("Could not find editor constructor for model: " + this.model);
            }
        ...
        @Override
		public ParameterEditor getParameterEitorInstance() {
