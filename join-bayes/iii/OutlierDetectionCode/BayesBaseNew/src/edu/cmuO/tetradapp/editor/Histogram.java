...
import edu.cmu.tetrad.data.Discretization;
 ...
 *
 * @author Tyler Gibson
 * @version $Revision: 1.1 $ $Date: Nov 28, 2006 12:41:01 PM $
 */
public class Histogram {
     ...
     * @param selectedNode
     */
    public Histogram(RectangularDataSet dataSet, Node selectedNode, int categories) {
        if (dataSet == null) {
    ...
    private void buildHistogramData() {
        if (this.frequencies == null) {
            ...
            if (spec == null) {
                ...
                Discretization discretization = Discretization.discretize(getValues(),
