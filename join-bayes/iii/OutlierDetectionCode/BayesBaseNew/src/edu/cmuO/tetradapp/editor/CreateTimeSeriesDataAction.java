 ...
 * @version $Revision: 5008 $ $Date: 2006-01-20 13:34:55 -0500 (Fri, 20 Jan
 *          2006) $
 */
final class CreateTimeSeriesDataAction extends AbstractAction {
	...
	public void actionPerformed(ActionEvent e) {
        ...
        this.dataSet = (RectangularDataSet) dataModel;

        SpinnerNumberModel spinnerNumberModel =
                new SpinnerNumberModel(getNumLags(), 2, 20, 1);
        ...
        EditorWindow editorWindow = new EditorWindow(panel,
                "Create time series data", "Save", true);
    ...
    private void createContinuousTimeSeriesData() {
        ...
        RectangularDataSet _laggedData =
