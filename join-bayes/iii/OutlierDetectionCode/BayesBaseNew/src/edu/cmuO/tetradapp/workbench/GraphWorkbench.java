 ...
 * @version $Revision: 6376 $ $Date: 2005-10-06 10:43:33 -0400 (Thu, 06 Oct
 *          2005) $
...
public class GraphWorkbench extends AbstractWorkbench {
	...
	public IDisplayEdge getNewDisplayEdge(Edge modelEdge) {
        ...
        DisplayNode displayNodeA = (DisplayNode) getModelToDisplay().get(node1);
        DisplayNode displayNodeB = (DisplayNode) getModelToDisplay().get(node2);
     ...
     */
    private void adjustNameAndPosition(Node wrapper, int deltaX,
            int deltaY) {
        String originalName = wrapper.getName();
