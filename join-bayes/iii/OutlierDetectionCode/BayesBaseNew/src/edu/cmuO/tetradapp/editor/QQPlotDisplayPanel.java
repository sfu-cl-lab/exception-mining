...
public class QQPlotDisplayPanel extends JPanel {
	...
	public void paintComponent(Graphics graphics) {
        ...
        //int compColumn = this.qqPlot.getDataSet().getColumn(this.qqPlot.getComparisonVariable());
    ...
    public double[] plotPoint(double x, double y, double minRange, double maxRange) {
        ...
        result[0] = (WIDTH - 50) * ((x - minRange) / range) - 2 + 50;
        result[1] = HEIGHT - (HEIGHT - 50) * ((y - minRange) / range) - 2 - 50;
