 ...
 *
 * @author gmli
 * @version $Revision: 4837 $ $Date: 2005-03-07 13:55:02 -0500 (Mon, 07 Mar
 *          2005) $
 */
	...
	public void paint(Graphics g) {
        ...
        switch (getMode()) {
            ...
            case ANCHORED_UNSELECTED:
                Color c = new Color(LINE_COLOR.getRed(), LINE_COLOR.getGreen(),
                        LINE_COLOR.getBlue(), getVisibility());
                g.setColor(c);
        ...
        if (pp != null) {
            ...
            if (isSelfEdge) {
                ...
                QuadCurve2D arc = new QuadCurve2D.Float(pp.getFrom().x,
                        pp.getFrom().y, tempCPoint.x,
                        tempCPoint.y, pp.getTo().x,
                        pp.getTo().y);
                g2.draw(arc);
	...
	public Polygon getClickRegion() {
        ...
        if (getMode() == HALF_ANCHORED || !isSelfEdge) {
            ...
            if (clickRegion == null && pp != null) {
                ...
                int bisect_x =
                        (int) (((tempCPoint.x - mid.x)) / bisect_len);
                int bisect_y =
                        (int) (((tempCPoint.y - mid.y)) / bisect_len);
