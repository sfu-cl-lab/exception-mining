...
public class ExpressionManager {
    ...
    private ExpressionManager() {
        this.descriptors = new ArrayList<ExpressionDescriptor>(getDescriptors());
     ...
     */
    public List<ExpressionDescriptor> getDescritpors() {
     ...
     */
    private static List<ExpressionDescriptor> getDescriptors() {
    ...
    private static class NaturalLogExpressionDescriptor extends AbstractExpressionDescriptor {
        ...
        public NaturalLogExpressionDescriptor() {
            super("Natural Log", "log", Position.PREFIX, false, false, "number");
        }
