 ...
 * @version $Revision: 5970 $ $Date: 2006-01-06 15:57:49 -0500 (Fri, 06 Jan
 *          2006) $
 * @see SessionEditor
...
final class SessionEditorToolbar extends JPanel {
    ...
    private final ButtonInfo[] buttonInfos = new ButtonInfo[]{new ButtonInfo(
            ...
            new ButtonInfo("Compare", "Compare", "compare",
                    "<html>Add a node for a comparison object.</html>"),
...
//                "<html>Add a node for a prediction algorithm.</html>"),
    		...
    		new ButtonInfo("dbData", "dbData", "dbdata",
    		"<html>Add a dbDatar to the session.</html>"),
    		new ButtonInfo("dbEstimator", "dbEstimator", "dbest",
    		"<html>Add a dbEstimator to the session.</html>"),
