 ...
 * @version $Revision: 6069 $ $Date: 2006-01-20 13:45:01 -0500 (Fri, 20 Jan
 *          2006) $
 */
class TabularDataTable extends AbstractTableModel {
     ...
     */
    public TabularDataTable(RectangularDataSet dataSet) {
    ...
    /**
     * Returns the value at the given (row, col) coordinates of the table as
...
//        fireTableStructureChanged();
    ...
    private void setColumnName(int col, Object value) {
        dataSet.getVariable(col - getNumLeadingCols()).setName((String) value);
        pcs.firePropertyChange("modelChanged", null, null);
    }
...
//            dataSet.setDouble(dataRow, dataCol, (Double) value);
    ...
    private boolean isEmpty(RectangularDataSet dataSet, int column) {
