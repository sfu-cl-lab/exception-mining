 ...
 * @version $Revision: 5052 $ $Date: 2006-01-20 13:34:55 -0500 (Fri, 20 Jan
 *          2006) $
 */
public class GraphComparisonParams extends SessionAdapter
    ...
    public void addRecord(int adjCorrect, int adjFn, int adjFp,
            int arrowptCorrect, int arrowptFn, int arrowptFp, int arrowptAfn,
            int arrowptAfp) {
        ...
        dataSet.setInt(newRow, 6, arrowptAfn);
        dataSet.setInt(newRow, 7, arrowptAfp);
    }
	...
	public final void newExecution() {
        if (isResetTableOnExecute()) {
            ...
            DiscreteVariable arrowptAfn = new DiscreteVariable("APT_AFN");
            DiscreteVariable arrowptAfp = new DiscreteVariable("APT_AFP");
            ...
            variables.add(arrowptAfn);
            variables.add(arrowptAfp);
