 ...
 *
 * @author Tyler Gibson
 * @version $Revision: 1 $ $Date: Apr 30, 2007 5:46:08 AM $
 */
public class Transformation {
     ...
     *                        "valid".
     */
    public static void transform(RectangularDataSet data, String... equations) throws ParseException {
     ...
     */
    private static void transformEquation(RectangularDataSet data, String eq) throws ParseException {
     ...
     */
    private static void addVariableIfRequired(RectangularDataSet data, String var) {
    ...
    private static class DataBackedContext implements Context {
        ...
        public DataBackedContext(RectangularDataSet data, List<String> vars){
            this.data = data;
            for(String v : vars){
