...
/**
 * Implements a convervative version of PC, in which pairwise faithfulness
 * instead of faithfulness is appealed to.
 *
...
public final class Cpc implements GraphSearch {
    ...
    public Cpc(IndependenceTest independenceTest, Knowledge knowledge) {
    ...
    public Graph search(List<Node> nodes) {
        ...
        FastAdjacencySearch fas =
                new FastAdjacencySearch(graph, getIndependenceTest());
...
//                List<Node> condSet = Cpc.asList(choice, _nodes);
//
...
//    private TripleType getTripleType2(Node x, Node y, Node z,
//            IndependenceTest test, int depth) {
//        int numSepsetContainingY = 0;
//        int numSepsetNotContainingY = 0;
//
//        Set<Node> __nodes = new HashSet<Node>(this.graph.getAdjacentNodes(x));
//        __nodes.remove(z);
//
...
//                if (test.isIndependent(x, z, condSet)) {
//                    if (condSet.contains(y)) {
//                        numSepsetContainingY++;
//                    }
//                    else {
//                        numSepsetNotContainingY++;
//                    }
//                }
//            }
//        }
...
////        }
//
////        if (numSepsetContainingY == numSepsetNotContainingY) {
////            return TripleType.AMBIGUOUS;
////        } else if (!numSepsetNotContainingY) {
////            return TripleType.NONCOLLIDER;
////        } else {
////            return TripleType.COLLIDER;
////        }
//
//        if (numSepsetNotContainingY < numSepsetContainingY) {
//            return TripleType.NONCOLLIDER;
//        }
//        else if (numSepsetContainingY < numSepsetNotContainingY) {
//            return TripleType.COLLIDER;
//        }
//        else {
//            return TripleType.AMBIGUOUS;
