 ...
 * @version $Revision: 5574 $ $Date: 2006-01-08 23:44:17 -0500 (Sun, 08 Jan
 *          2006) $
 */
public class BooleanFunction implements TetradSerializable {
    ...
    public void randomize() {
        for (int i = 0; i < lookupTable.length; i++) {
            this.lookupTable[i] =
                    PersistentRandomUtil.getInstance().nextDouble() > 0.5;
        }
    }

    /**
     * Determines whether the current function is canalyzing, according to
