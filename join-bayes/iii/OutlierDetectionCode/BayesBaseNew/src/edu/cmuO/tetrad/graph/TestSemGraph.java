 ...
 * @version $Revision: 5694 $ $Date: 2005-05-25 10:18:24 -0400 (Wed, 25 May
 *          2005) $
 */
public final class TestSemGraph extends TestCase {
    ...
    public void test1() {
        ...
        graph.addBidirectedEdge(graph.getExogenous(b), graph.getExogenous(d));
        ...
        graph.addBidirectedEdge(c, graph.getExogenous(d));
        System.out.println(graph);
