...
/**
 * JUnit test for the procedure which finds a DAG which is an instance of a
 * pattern.
 *
...
public class TestPatternToDag extends TestCase {
    ...
    public void testChickeringAlgorithm() {
        ...
        PatternToDagSearch search1 = new PatternToDagSearch(pattern1);
        ...
        PatternToDagSearch search2 = new PatternToDagSearch(pattern2);
