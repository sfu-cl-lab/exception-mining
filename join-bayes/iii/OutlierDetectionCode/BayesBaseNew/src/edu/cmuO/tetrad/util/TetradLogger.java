 ...
 *
 * @author Tyler Gibson
 * @version $Revision: 1.1 $ $Date: Mar 20, 2007 10:40:12 PM $
 */
...
public class TetradLogger {
     ...
     */
    private Map<OutputStream, Writer> writers = new LinkedHashMap<OutputStream, Writer>();
     ...
     */
    private Map<Class, TetradLoggerConfig> configMap = new ConcurrentHashMap<Class, TetradLoggerConfig>();
     ...
     * The listeners.
     */
    private List<TetradLoggerListener> listeners = new ArrayList<TetradLoggerListener>();
    ...
    public void setTetradLoggerConfigForModel(Class model) {
        ...
        if (config == null) {
            System.out.println("There is no pre-defined config for the model " + model);
        }
