 ...
 *
 * @author David Danks
 * @version $Revision: 4609 $; Mar 20, 2002
 */
final class PossibleDSepSearch3 {
     ...
     */
    public PossibleDSepSearch3(Graph graph, SepsetMap sepset, IndependenceTest test,
    ...
    private List<Node> possibleParents(Node x, List<Node> nodes, Knowledge knowledge) {
        ...
        for (Node z : nodes) {
            ...
            if (PossibleDSepSearch3.possibleParentOf(_z, _x, knowledge)) {
