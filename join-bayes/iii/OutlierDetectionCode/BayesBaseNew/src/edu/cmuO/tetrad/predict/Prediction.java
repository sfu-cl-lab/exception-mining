 ...
 * @version $Revision: 6549 $ $Date: 2006-01-08 23:44:17 -0500 (Sun, 08 Jan
 *          2006) $
 */
public final class Prediction implements TetradSerializable {
    ...
    public Prediction(Pag pag, RectangularDataSet dataContinuous,
    ...
    public static Prediction serializableInstance() {
        return new Prediction(Pag.serializableInstance(),
    ...
    private SemIm estimatedSemIm(Dag G, RectangularDataSet d) {
    ...
    private boolean possDConnectedToAltered(Graph G, Node node1, Set nodes2,
        ...
        while (true) {
            ...
            for (int i = 0; i < currEdges.size(); i++) {
                ...
                if (special_flag && center.equals(node1))
                {     //paths out of node 1 not allowed for IP
