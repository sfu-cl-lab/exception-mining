...
public final class GesSearch implements GraphSearch {
    /**
    ...
    public GesSearch(RectangularDataSet dataSet) {
        setDataSet(dataSet);
        initialize(10., 0.001);
    }

    public GesSearch(CovarianceMatrix covMatrix) {
        setCorrMatrix(new CorrelationMatrix(covMatrix));
        initialize(10., 0.001);
    }

    public GesSearch(RectangularDataSet dataSet, Graph trueGraph) {
        setDataSet(dataSet);
        initialize(10., 0.001);
