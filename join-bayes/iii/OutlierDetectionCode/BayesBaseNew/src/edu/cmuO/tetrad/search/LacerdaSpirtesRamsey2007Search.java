...
//	 * @param iMinusB
	 */
	@Override
	public GraphWithParameters run(RectangularDataSet dataSet//, DoubleMatrix2D iMinusB
			) {
...
//			System.out.println(" variableNthMoment for row "+i+" = " + variableNthMoment);
	...
	//	B^ = I - W~'
	private static RectangularDataSet computeBhatMatrix(DoubleMatrix2D normalizedZldW, int n, List<Node> nodes){//, List<Integer> perm) {
