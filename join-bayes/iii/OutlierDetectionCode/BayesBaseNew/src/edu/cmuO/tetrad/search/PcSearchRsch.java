...
public class PcSearchRsch implements GraphSearch {
    ...
    /**
     * Count of false positive edges involved in false positive collider
     * orientations.
     */
    private int cefp;

    /**
     * Count of false negative edges involved in false positive collider
     * orientations.
     */
    private int cefn;

    /**
     * Count of false positive independencies involved in false positive
     * collider orientations.
     */
    private int cindfp;
    ...
    public Graph search(List<Node> nodes) {
        TetradLogger.getInstance().info("Starting PC algorithm.");
...
//        orientUsingMeekRules(knowledge, graph);
     ...
     */
    public void orientCollidersUsingSepsets(SepsetMap set, Knowledge knowledge,
            Graph graph) {
        ...
        for (Node a : nodes) {
            ...
            while ((combination = cg.next()) != null) {
                ...
                if (!sepset.contains(a) &&
                    ...
                    TetradLogger.getInstance().info(SearchLogUtils.colliderOrientedMsg(b, a, c, sepset));
                    ...
                    // true noncollider.  FALSE POSITIVE
                    else {
                        printSubsetMessage(graph, b, a, c, sepset);
