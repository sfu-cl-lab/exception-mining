 ...
 * @version $Revision: 6118 $ $Date: 2005-11-19 15:06:57 -0500 (Sat, 19 Nov
 *          2005) $
 */
public final class SimulationStudy {
    ...
    public void execute(SessionNode sessionNode, boolean overwrite) {
        ...
        TetradLogger.getInstance().forceLogMessage("Time = " + new Date());
    ...
    private boolean execute(LinkedList<SessionNode> tierOrdering, boolean doRepetition,
        ...
        TetradLogger.getInstance().info("\n***EXECUTING " + sessionNode.getDisplayName()
            + "***\n");
