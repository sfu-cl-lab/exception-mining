 ...
 * @version $Revision: 6294 $ $Date: 2006-01-20 13:34:55 -0500 (Fri, 20 Jan
 *          2006) $
 */
public class TestSemEstimator extends TestCase {
    ...
    public static void rtestSet0() {
        ...
        CovarianceMatrix covMatrix = constructCovMatrix0();
    ...
    public void testSet2() {
        ...
        SemPm semPm = new SemPm(graph);
        CovarianceMatrix covMatrix = constructCovMatrix2();
        SemEstimator estimator = new SemEstimator(covMatrix, semPm);
        System.out.println();
        System.out.println("... Before:");
        System.out.println(estimator);
...
//        DoubleMatrix2D arr2 = new DenseDoubleMatrix2D(arr);
        return new CovarianceMatrix(vars, arr, 173);
    }
    ...
    private CovarianceMatrix constructCovMatrix1() {
        ...
        return new CovarianceMatrix(vars, m2, 1000);
    }
    ...
    private CovarianceMatrix constructCovMatrix2() {
        ...
        double[][] m = MatrixUtils.convertLowerTriangleToSymmetric(arr);
//        DoubleMatrix2D m2 = new DenseDoubleMatrix2D(m);
        return new CovarianceMatrix(vars, m, 1000);
    }
}
