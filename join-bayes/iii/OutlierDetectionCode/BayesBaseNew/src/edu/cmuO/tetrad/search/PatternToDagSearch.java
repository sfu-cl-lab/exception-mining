...
/**
 * Given a pattern this class implements two algortithms for finding an
 * associated directed acyclic graph (DAG).
 * <p/>
 * The first algorithm (in patternToDatMeek) was described in Zhang and Spirtes
 * (2005), "A Characterization of Markov Equivalence Classes for Ancestral
 * Graphical Models" on pp. 53-54.
 * <p/>
 * The second algorithm (in patternToDagDorTarsi) was described by Chickering
 * (2002) in "Optimal Structure Identification with Greedy Search" in the
 * Journal of Machine Learning Research.  The algorithm was proposed by Dor and
 * Tarsi (1992).
 *
 * @author Frank Wimberly
 */
public class PatternToDagSearch {
    ...
    public PatternToDagSearch(Pattern pattern) {
        if (pattern == null) {
    ...
    /**
     * This algorithm is due to Meek (1995) and was described by Zhang and
     * Spirtes (2005), "A Characterization of Markov Equivalence Classes for
     * Ancestral Graphical Models" on pp. 53-54.
     * <p/>
...
//    }
    ...
    public Dag patternToDagDorTarsi() {
        ...
        for (Edge edge : allEdges) {
            ...
            if (pattern.isDirectedFromTo(edge.getNode2(), edge.getNode1())) {
    ...
    /**
     * Returns a boolean which indicates whether a list of nodes forms a clique.
     * That is, is the subgraph determined by those nodes complete.  If so,
     * every pair of the nodes is adjacent.
     *
     * @param g a graph
