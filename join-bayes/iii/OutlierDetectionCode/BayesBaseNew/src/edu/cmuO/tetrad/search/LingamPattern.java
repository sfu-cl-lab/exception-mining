...
public class LingamPattern {
    ...
    public LingamPattern() {

    }

    public Result search(Graph pattern, RectangularDataSet dataSet) throws IllegalArgumentException {
        return search(SearchGraphUtils.getDagsInPatternMeek(pattern, new Knowledge()), dataSet);
    }
...
//     * @param pattern
     ...
     */
    public Result search(List<Dag> dags, RectangularDataSet dataSet) throws IllegalArgumentException {
...
//        }
        ...
        if (dags.size() == 0) {
            return new Result(new ArrayList<Dag>(), new ArrayList<Integer>(), numSamples);
        }
        ...
        for (int k = 0; k < getNumSamples(); k++) {
            ...
            DoubleMatrix2D sample = getBootstrapSample(data, bootstrapSize);
...
//                max = i;
        ...
        List<Dag> outputDags = new ArrayList<Dag>();
    ...
    public static class Result {
        ...
        public Result(List<Dag> dags, List<Integer> counts, int numSamples) {
            this.setDags(dags);
