...
public final class TestCollisions extends TestCase {
    ...
    private void checkGraph(Graph graph) {
        ...
        assertTrue(graph.isDefiniteCollider(x1, x2, x3));
        ...
        assertTrue(graph.isDefiniteNoncollider(x1, x2, x3));
        ...
        assertFalse(graph.isDefiniteNoncollider(x1, x2, x3));
        assertFalse(graph.isDefiniteCollider(x1, x2, x3));
