...
/**
 * Euclidean dissimilarity metric--i.e., the square root of the sum of the
 * differences in corresponding variable values.
 *
 * @author Joseph Ramsey
 */
public class AbsoluteErrorLoss implements Dissimilarity {
    @Override
