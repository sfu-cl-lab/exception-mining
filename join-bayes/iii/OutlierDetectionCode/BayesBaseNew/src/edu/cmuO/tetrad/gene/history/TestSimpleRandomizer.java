...
public class TestSimpleRandomizer extends TestCase {
    ...
    public void testConstantIndegree() {
        ...
        // Pick an indegree.
        int indegree = PersistentRandomUtil.getInstance().nextInt(8) + 2;

        // Pick mlag.
        int mlag = PersistentRandomUtil.getInstance().nextInt(9) + 1;

        // Pick percent housekeeping.
        double percentHousekeeping =
                PersistentRandomUtil.getInstance().nextDouble() * 20.0;
    ...
    public void testMeanIndegree() {
        ...
        if (numNonHousekeeping > 0) {
            ...
            assertEquals(indegree, mean, 1.2);
        }
    }
