 ...
 */
public class TestNifti extends TestCase {
    private PrintWriter csvOut;

    public TestNifti(String name) {
        super(name);
    }
...
//    }
    ...
    public static Test suite() {
        return new TestSuite(TestNifti.class);
    }
}
