 ...
 * likelihood estimates of the parameters of a Sem for a given sample; it
 * contains member variables for storing the results of such a computation. The
 * values of the parameters are a search procedure based on Powell's method for
...
//        TetradLogger.getInstance().log("info", "Wiggling each parameter in turn...");
//
...
//                System.out.println("Cube width = " + width + " partial = " + partial + " FML = " + f);
     ...
     *
     * @author Joseph Ramsey
     * @version $Revision: 5781 $ $Date: 2005-07-06 13:39:56 -0400 (Wed, 06 Jul
     *          2005) $
     */
    ...
    private RandomUtil getRandom() {
        return PersistentRandomUtil.getInstance();
    }
}
