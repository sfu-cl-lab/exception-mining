 ...
 * model is the outerProduct of the scores of its factors.  Since the log of the
...
final class BdeMetricCache {
    ...
    public BdeMetricCache(RectangularDataSet dataSet, BayesPm bayesPm) {
...
//        DiscreteVariable var = (DiscreteVariable) variables.get(index);

        //int numCols = var.getNumSplits();
...
//                if (rawData[index][i] != -99) {
                if (dataSet.getInt(i, index) != -99) {
                    ...
                    //Compute marginal probabilities of each value  of var and increase
            ...
            for (int row = 0; row < numRows; row++) {
                ...
                for (int i = 0; i < numCases; i++) {
                    ...
                    //compute the joint marginal distrubiton for var and this combination
