 ...
 * @version $Revision: 6069 $ $Date: 2006-01-11 13:28:30 -0500 (Wed, 11 Jan
 *          2006) $
 */
public final class DiscreteVariable extends AbstractVariable
    ...
    public final List<String> getCategories() {
        if (this.categories == null) {
            this.categories = getStoredCategoryList(this.categoriesCopy);
        }
    ...
    private void setCategories(String[] categories) {
        ...
        this.categoriesCopy = getStoredCategoryList(categoryList);
    }
    ...
    private static List<String> getStoredCategoryList(
        ...
        for (LinkedList<String> aSTORED_CATEGORY_LISTS : STORED_CATEGORY_LISTS)
        {
            if (categorySet.equals(
                    new HashSet<String>(aSTORED_CATEGORY_LISTS)))
            {
                return aSTORED_CATEGORY_LISTS;
            }
        }
