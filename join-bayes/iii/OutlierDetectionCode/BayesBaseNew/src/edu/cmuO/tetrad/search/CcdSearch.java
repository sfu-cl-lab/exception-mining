 ...
 * @version $Revision: 6075 $ $Date: 2006-01-20 14:37:15 -0500 (Fri, 20 Jan
 *          2006) $
 */
public final class CcdSearch {
     ...
     */
    public CcdSearch(IndependenceTest test, Knowledge knowledge) {
        this.knowledge = knowledge;
        this.test = test;
        this.nodes = new LinkedList<Node>(test.getVariables());
        this.underLineTriples = new ArrayList<Triple>();
        this.dottedUnderLineTriples = new ArrayList<Triple>();
    }
     ...
     * use of background knowledge will be done later.
     */
    public CcdSearch(IndependenceTest test) {
