...
import edu.cmu.tetrad.search.TestFastIca;
...
public class TestSem2 extends TestCase {
    ...
    public void testSem2() {
        RectangularDataSet data = getData();
        ...
        try {
            ...
            DataSavers.saveRectangularData(data, out, ',');
            out.flush();
            out.close();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void testSem2_2() {
        ...
        RectangularDataSet data = im.simulateData(500, new UniformDistribution(-1, 1));
    ...
    private RectangularDataSet getData() {
...
//        pm.setDistributionType(x1, DistributionType.UNIFORM);
        ...
        return im.simulateData(1000, new UniformDistribution(-1, 1));
    }

    private RectangularDataSet getData2() {
        Graph graph = constructGraph1();
...
//        System.out.println(pm.getDistributionParameters(x1));
        ...
        DoubleMatrix2D matrix = TestFastIca.simulate(pwp, 1000, new BetaDistribution(0.2, 0.3));
    ...
    public void testSampleBeta() {
        BetaDistribution dist = new BetaDistribution(1, 2);

        for (int i = 0; i < 100; i++) {
            System.out.println(dist.nextRandom());
        }
    }
