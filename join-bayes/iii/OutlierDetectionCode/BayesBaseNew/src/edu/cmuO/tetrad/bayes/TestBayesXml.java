...
//Hassan changed an exception in this file

/**
 * Tests the Bayes XML parsing/rendering.
 *
 * @author Joseph Ramsey
 * @version $Date: 2007-07-19 14:30:12 -0400 (Thu, 19 Jul 2007) $
 */
public final class TestBayesXml extends TestCase {
    ...
    public static void testRoundtrip3() {
    ...
    public static void testLoadFromFile() {
        try {
            ...
            Document document =
                    builder.build(new File("test_data/parsableBayesNet.xml"));
