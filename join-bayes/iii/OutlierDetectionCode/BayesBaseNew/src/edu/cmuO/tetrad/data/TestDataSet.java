 ...
 * @version $Revision: 6438 $ $Date: 2006-01-20 13:34:55 -0500 (Fri, 20 Jan
 *          2006) $
 */
public final class TestDataSet extends TestCase {
    ...
    public final void testContinuous() {
        ...
        RectangularDataSet dataSet = new ColtDataSet(rows, _variables);
        ...
        RectangularDataSet _dataSet = dataSet.subsetColumns(newVars);
    ...
    public static void testDiscrete() {
        ...
        RectangularDataSet dataSet = new ColtDataSet(rows, variables);
        RandomUtil randomUtil = PersistentRandomUtil.getInstance();
    ...
    public static void testInitialization() {
        ...
        RectangularDataSet dataSet = new ColtDataSet(5, variables);

        System.out.println(dataSet);
    }

    public static void testDiscreteFromScratch() {
        RectangularDataSet dataSet = new ColtDataSet(0, Collections.EMPTY_LIST);
    ...
    public static void testRowSubset() {
        ...
        RectangularDataSet _dataSet = dataSet.subsetRows(new int[]{0, 1, 2});
    ...
    public static Test suite() {
        ...
        // of this class.
        return new TestSuite(TestDataSet.class);
    }
}
