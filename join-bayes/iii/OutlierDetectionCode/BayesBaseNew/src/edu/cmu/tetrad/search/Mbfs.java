...
//        logger.info("target = " + getTarget());
    ...
    /**
     * Adds associates of the target and prunes edges using subsets of adjacents to the target.
     *
     * @param target The variable whose Markov blanket is sought.
     * @param graph  The current search graph.
     */
...
//        System.out.println("***************NUMASSOC = " + numAssociated);
     ...
     * @param graph The current search graph, to be modified by pruning.
...
//        }
    ...
    /**
     * Removes from adjx any adjacents that cannot be parents of x given the background knowledge.
     *
     * @param node    The node being discussed.
     * @param adjNode The list of adjacents to <code>node</code>.
