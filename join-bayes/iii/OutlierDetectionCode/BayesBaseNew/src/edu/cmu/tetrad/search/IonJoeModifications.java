...
//        outputSet = applyKnowledge(outputSet);
     ...
     * possible GraphChanges which could be used to block said paths
     */
...
//                awayFromCycle(graph, C, B, A);
    ...
    private Set<Graph> checkPaths(Set<Graph> pags) {
        ...
        for (Graph pag : pags) {
            ...
            // We take for granted that treks exists for edges, but only because the the notion of trek in
            // EdgeListGraph is for Patterns, not PAGs.
