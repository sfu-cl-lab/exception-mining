...
public class TemplateExpander {
     ...
     * expression for the node or parameters you wish to use it for.
     *
     ...
     *                 the parents of <code>node</code> are, and in order to determine new parameters. May be null. If it is null,
    ...
    private String replaceTemplateSums(GeneralizedSemPm semPm, String formula, Node node)
        ...
        return replaceLists("TSUM", semPm, formula, node);
    }

    private String replaceTemplateProducts(GeneralizedSemPm semPm, String formula, Node node)
            throws ParseException {
        return replaceLists("TPROD", semPm, formula, node);
    }
