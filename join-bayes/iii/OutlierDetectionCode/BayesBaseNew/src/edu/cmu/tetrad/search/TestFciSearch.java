...
public class TestFciSearch extends TestCase {
    ...
    public void testSearch1() {
        ...
        checkSearch("X1-->X2,X1-->X3,X2-->X4,X3-->X4",
                "X1o-oX2,X1o-oX3,X2-->X4,X3-->X4", new Knowledge()); // With Jiji's R9.
    }
...
//        checkSearch("Latent(E),Latent(G),E-->D,E-->H,G-->H,G-->L,D-->L,D-->M," +
//                "H-->M,L-->M,S-->D,I-->S,P-->S",
//                "D<-oH,Ho-oL,D-->L,D-->M,Ho-oM,Lo-oM,S-->D,Io->S,Po->S", new Knowledge());
...
//                "A<->B,B-->E,Co-oH,D-->A,E<->A,E<->D,Fo->B,Fo-oC,Ho->D", new Knowledge());
    }
    ...
    public void rtestSearch4() {
        ...
        Dag trueGraph = GraphUtils.randomDag(numVars, 10, numEdges, 7, 5,
                5, false);
...
//        System.out.println(resultGraph);
    ...
    public void rtestSearch6() {
        ...
        Dag trueGraph = GraphUtils.randomDag(numVars, numLatents, numEdges, 7, 5,
                5, false);
