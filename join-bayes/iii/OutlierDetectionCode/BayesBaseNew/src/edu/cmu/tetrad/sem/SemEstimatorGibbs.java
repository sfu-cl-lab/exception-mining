 ...
 //       return new SemEstimatorGibbs(null, null);
  //  }
    ...
    public void estimate() {  //dogibbs in pascal
		...
		DoubleMatrix2D data = new DenseDoubleMatrix2D(parameters.size(), numIterations/50);
        ...
        //GIBBSINIT
        DoubleMatrix2D impliedCovMatrix = this.startIm.getImplCovar(); // why is this never used?
        //GIBBSINIT DONE
