...
public class BuildPureClusters3 {
    ...
    public BuildPureClusters3(ICovarianceMatrix cov, TestType testType, double alpha) {
        this.cov = cov;
    ...
    public BuildPureClusters3(DataSet dataSet, TestType testType, double alpha) {
