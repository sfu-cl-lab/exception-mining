...
//                Iterator ci = semIm.getSemIm().getGraph().getChildren(exo1)
//                        .iterator();
//                exo1 =
//                        (Node) ci.next(); //Assuming error nodes have only one children in SemGraphs...
//                ci = semIm.getSemIm().getGraph().getChildren(exo2).iterator();
//                exo2 =
//                        (Node) ci.next(); //Assuming error nodes have only one children in SemGraphs...
    ...
    private double gaussianMaximization(SemIm semIm) {
        ...
        //semIm = SemIm.newInstance(realIm.getSemIm());
...
//                Iterator ci = semIm.getSemIm().getGraph().getChildren(exo)
//                        .iterator();
//                exo =
//                        (Node) ci.next(); //Assuming error nodes have only one children in SemGraphs...
                ...
                for (int ii = 0; ii < this.nSpouses[i]; ii++) {
                    for (int j = ii; j < this.nSpouses[i]; j++) {
                        ...
                        if (this.pseudoParentsCov[i][this.parents[i].length +
                            ...
                            System.out.println(semIm.getSemIm().getDag());
...
//                for (Node parent : semIm.getSemIm().getGraph().getParents(node)) {
...
//                        for (Iterator it = semIm.getSemIm().getGraph()
