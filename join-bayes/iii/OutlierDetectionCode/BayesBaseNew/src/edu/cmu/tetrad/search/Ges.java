...
//                    System.out.println("t neighbors = " + tNeighbors);
                    ...
                    for (Set<Node> tSubset : tSubsets) {
                        ...
                        double insertEval = insertEval(_x, _y, tSubset, naYX, graph);
...
//                        }
                        ...
                        TetradLogger.getInstance().log("edgeEvaluations", "Trying to add " + _x + "-->" + _y + "t = " +
                                tSubset + " evalScore = " + evalScore);
//                        System.out.println( "Trying to add " + _x + "-->" + _y + " evalScore = " + "t = " + tSubset + " evalScore = " +
//                                                evalScore);
...
//        System.out.println("   Score graph change set1 = "  + set1 + " set2 = " + set2 + "score = " + score);
