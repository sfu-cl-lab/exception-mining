...
CREATE TABLE RNodes_From_List AS SELECT DISTINCT rnid, CONCAT('Premier_League_MidFielder_Dec2015.',TABLE_NAME, ' AS ', pvid) AS Entries FROM
    RNodes_pvars 
UNION DISTINCT 
SELECT DISTINCT
    rnid, CONCAT('Premier_League_MidFielder_Dec2015.',TABLE_NAME, ' AS ', rnid) AS Entries
FROM
    RNodes 
...
CREATE TABLE ADT_PVariables_From_List AS SELECT pvid, CONCAT('Premier_League_MidFielder_Dec2015.',TABLE_NAME, ' AS ', pvid) AS Entries FROM
    PVariables;
