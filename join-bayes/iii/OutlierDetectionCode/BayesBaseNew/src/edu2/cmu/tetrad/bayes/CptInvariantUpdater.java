...
public final class CptInvariantUpdater implements ManipulatingBayesUpdater {
    ...
    public void setEvidence(Evidence evidence) {
        ...
        this.manipulatedBayesIm = createManipulatedBayesIm(manipulatedBayesPm);
        ...
        this.cptInvariantMarginalCalculator =
                new CptInvariantMarginalCalculator(manipulatedBayesIm,
                        evidence2);
    }
    ...
    private BayesIm createManipulatedBayesIm(BayesPm updatedBayesPm) {
