...
*/
    ...
    public void transferNodesAndEdges(Graph graph)
        ...
        for (Object o1 : graph.getEdges()) {
            ...
            if (!addEdge(edge)) {
            //@Aug 27
                System.out.print("Cannot add the edge\n");
            //throw new IllegalArgumentException();
            }
        }
    }
...
//        }
        ...
        for (Edge edge : edges) {
            adjacentNodesHash.add(edge.getDistalNode(node));
        }

        return new ArrayList<Node>(adjacentNodesHash);
    }
    ...
    public boolean addEdge(Edge edge) {
        ...
        //@Aug 27
        System.out.println("Violate Constraints\n");
           /* throw new IllegalArgumentException(
