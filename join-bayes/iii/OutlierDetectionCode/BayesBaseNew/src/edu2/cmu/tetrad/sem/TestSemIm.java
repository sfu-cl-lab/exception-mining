...
//        DataSet data = im.simulateDataRecursive(1000, true);
    ...
    public void test6() {
        ...
        DoubleMatrix2D iMinusB = I.copy().assign(B, PlusMult.plusMult(-1));
        ...
        DoubleMatrix1D e = new DenseDoubleMatrix1D(2);
        ...
        DoubleMatrix1D x = new Algebra().mult(reduced, e);

        System.out.println(x);

        DoubleMatrix1D d1 = new Algebra().mult(B, x);
