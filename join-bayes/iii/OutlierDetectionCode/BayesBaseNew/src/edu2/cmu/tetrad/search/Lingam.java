...
//        fastIca.setTolerance(1e-20);
        edu.cmu.tetrad.cluster.FastIca.IcaResult result = fastIca.findComponents();
...
//        }
        ...
        return new EstimateResult(B, estdisturbancesstd.toArray(), cest.toArray(),
                causalperm, Wout);
    }
