...
*/
/* at the end of this file we copy information from Knowledge_Required_Edges into Path_Required_Edges. It doesn't make sense to drop the Knowledge_tables
...
/*propagate edges from knowledge */
