...
//                                                    this.rawdata[y][r], y)]++;
    ...
    public boolean oneFactorTest(int i, int j, int k, int l) {
        ...
        ICovarianceMatrix covarianceMatrix =
                new CovarianceMatrix(DataUtils.createContinuousVariables(vNames), new DenseDoubleMatrix2D(ulCorr),
        ...
        ICovarianceMatrix covMatrix = new CovarianceMatrix(DataUtils.createContinuousVariables(vNames), new DenseDoubleMatrix2D(est.getEstimatedSem().getImplCovarMeas().toArray()),
                this.dataSet.getNumRows());
    ...
    public boolean oneFactorTest(int i, int j, int k, int l, int x, int y) {
        ...
        CorrelationMatrix correlationMatrix = new CorrelationMatrix(
                new CovarianceMatrix(DataUtils.createContinuousVariables(vNames), new DenseDoubleMatrix2D(est.getEstimatedSem().getImplCovarMeas().toArray()),
                        dataSet.getNumRows()));
