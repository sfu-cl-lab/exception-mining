...
//    private Distribution coefDistribution = new UniformDistribution(1, 1.5);
...
//                param.setDistribution(coefDistribution);
        ...
        // Add error variance parameters for exogenous nodes of all *parameterizable* nodes.
        ...
        // Add mean parameters for all parameterizable nodes.
        for (Node node : getVariableNodes()) {
            if (!graph.isParameterizable(node)) {
                continue;
            }
