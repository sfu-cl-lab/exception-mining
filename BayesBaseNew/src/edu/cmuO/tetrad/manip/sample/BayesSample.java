...
public class BayesSample implements Sample {
    ...
    public BayesSample(BayesIm correctIm,
        ...
        RectangularDataSet dataSet = correctManipulatedGraphIM.simulateData(sampleSize, sampleSeed, false);
    ...
    public String [] getSampleCaseColumnNames(VariablesStudied studiedVariables) {
        int i, j;
        //String [] varNames = dataSetProbs.getDataSet().getVariableNames();
        //String [] varNames = (String[]) dataSetProbs.getDataSet().getVariableNames().toArray();
    ...
    public String [] getSampleCase(int row, VariablesStudied studiedVariables) {
        ...
        Iterator it;
        //String [] varNames = dataSetProbs.getDataSet().getVariableNames();
        //String [] varNames = (String[]) dataSetProbs.getDataSet().getVariableNames();
        ...
        RectangularDataSet dataSet = dataSetProbs.getDataSet();
     ...
     */
    private static int [] sampleFrequenciesIndexFunction(BayesIm IM, VariablesStudied studiedVariables, RectangularDataSet data, int row) {
