 ...
 * @see BayesPm
 */
public interface BayesIm extends VariableSource {
     ...
     */
    RectangularDataSet simulateData(int sampleSize, boolean latentDataSaved);
     ...
     * @return the simulated sample as a DataSet.
     */
    RectangularDataSet simulateData(RectangularDataSet dataSet, boolean latentDataSaved);
