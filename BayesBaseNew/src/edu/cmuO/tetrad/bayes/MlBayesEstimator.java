 ...
 * @version $Revision: 5761 $ $Date: 2006-01-20 13:34:55 -0500 (Fri, 20 Jan
 *          2006) $
 */
public final class MlBayesEstimator {
    private RectangularDataSet reorderedDataSetDiscrete;
     ...
     */
    public BayesIm estimate(BayesPm bayesPm, RectangularDataSet dataSet) {
        if (bayesPm == null) {
        ...
        RectangularDataSet columnDataSet2 = dataSet.subsetColumns(variables);
            ...
            for (int row = 0; row < numRows; row++) {
                ...
                for (int col = 0; col < numCols; col++) {
                    ...
                    if (condition.existsCombination()) {
                        double p = discreteProbs.getConditionalProb(assertion,
                                condition);
    ...
    public RectangularDataSet getReorderedDataSet() {
