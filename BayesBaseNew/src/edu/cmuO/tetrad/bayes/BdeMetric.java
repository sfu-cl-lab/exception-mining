 ...
 * @version $Revision: 5177 $ $Date: 2006-01-09 00:19:55 -0500 (Mon, 09 Jan
 *          2006) $
 */
final class BdeMetric {
    ...
    public BdeMetric(RectangularDataSet dataSet, BayesPm bayesPm) {
    ...
    public double score() {
        ...
        priorProbs = new double[nodes.length][][];

        int[][] observedCountsRowSum = new int[nodes.length][];
        priorProbsRowSum = new double[nodes.length][];
