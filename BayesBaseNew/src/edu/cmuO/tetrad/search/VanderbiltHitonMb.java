...
/**
 * Implementation of HITON-MB following Matlab code by authors. Note that
 * the full HITON algorithm includes a cross-classification wrapper, which
 * is not implemented here.
 *
 * @author Joseph Ramsey
 */
public class VanderbiltHitonMb implements MarkovBlanketSearch {
