 ...
 * conditional G Square test. A description of such a test is given in Fienberg,
 * "The Analysis of Cross-Classified Categorical Data," 2nd edition. The formula
 * for degrees of freedom used in this test are equivalent to the formulation on
 * page 142 of Fienberg.
 *
...
public final class IndTestGSquare implements IndependenceTest {
    ...
    /**
     * The variables in the discrete data sets or which conditional independence
     ...
     */
    public IndTestGSquare(RectangularDataSet dataSet, double alpha) {
	...
	public boolean splitDetermines(List<Node> z, Node x, Node y) {
        ...
        boolean splitDetermined =
                gSquareTest.isSplitDetermined(testIndices, getDeterminationP());
