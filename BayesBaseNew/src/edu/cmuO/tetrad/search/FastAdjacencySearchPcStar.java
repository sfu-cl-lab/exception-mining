 ...
 * @version $Revision: 6552 $ $Date: 2006-01-20 13:34:55 -0500 (Fri, 20 Jan
 *          2006) $
 */
public class FastAdjacencySearchPcStar {
     ...
     */
    public FastAdjacencySearchPcStar(Graph graph, IndependenceTest test) {
        this.graph = graph;
        this.test = test;
    }
