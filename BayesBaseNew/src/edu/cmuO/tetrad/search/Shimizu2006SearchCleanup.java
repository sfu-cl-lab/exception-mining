...
public final class Shimizu2006SearchCleanup {
    ...
    public static ColtDataSet lingamDiscoveryBhat(RectangularDataSet dataSet) {
...
//			System.out.println("tempMat = " + tempMat);
     ...
     */
    public static ShimizuResult lingamDiscoveryDag(RectangularDataSet dataSet) {
//        System.out.println("");
//        System.out.println("****************************************************");
...
//		System.out.println("containsAllZeros: returning true");
    ...
    private static ColtDataSet pruneEdges(ColtDataSet B, RectangularDataSet dataSet, double alpha, int nPieces) {
        return pruneEdgesBySampling(B, dataSet, alpha, nPieces);
    }


    private static ColtDataSet pruneEdgesBySampling(ColtDataSet B, RectangularDataSet dataSet, double alpha, int nPieces) {
        ...
        for (int i = 0; i < nPieces; i++) {
            RectangularDataSet currentDataSet = getSubsetOfDataSet(dataSet, nPieces, i);
