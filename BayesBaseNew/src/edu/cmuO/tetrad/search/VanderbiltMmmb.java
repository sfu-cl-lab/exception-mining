...
/**
 * Implements the Min-Max Markov Blanks (MMMB) algorithm as defined in
 * Tsamardinos, Aliferis, and Statnikov, Time and Sample Efficient Discovery of
 * Markov Blankets and Direct Causal Relations (KDD 2003).
 *
 * @author Joseph Ramsey
 */
public final class VanderbiltMmmb implements MarkovBlanketSearch {
     ...
     */
    public VanderbiltMmmb(IndependenceTest test, int depth, boolean symmetric) {
        if (test == null) {
	...
	public List<Node> findMb(String targetName) {
        TetradLogger.getInstance().info("target = " + targetName);
        numIndTests = 0;
        ...
        TetradLogger.getInstance().info("Number of seconds: " + (time2 / 1000.0));
...
//                mb.add(x);
    ...
    private List<Node> mmpc(Node t) {
        ...
        TetradLogger.getInstance().details("PC(" + t + ") = " + pc);
    ...
    /**
     * Trims away false positives from the given node. Used in the symmetric
     * algorithm.
     */
