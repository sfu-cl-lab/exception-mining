...
/**
 * Reimplemented HITON for purposes of comparison to other algorithms, to
 * get it closer to the published definition.
 *
 * @author Joseph Ramsey
 */
public class HitonVariant implements MarkovBlanketSearch {
