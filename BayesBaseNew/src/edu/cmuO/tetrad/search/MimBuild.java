 ...
 * @version $Revision: 6039 $ $Date: 2007-07-19 14:30:12 -0400 (Thu, 19 Jul 2007) $
 */
...
//        SearchGraphUtils.pcOrient(sepset, getKnowledge(), latent_graph,
    ...
    private Graph mimBuildGesSearch() {
        ...
        do {
            CovarianceMatrix newCovMatrix = (new CovarianceMatrix(varNames,
                    optimizer.getExpectedCovarianceMatrix(),
                    covMatrix.getSampleSize())).getSubmatrix(latentVarNames);
            score = newScore;
            GesSearch ges = new GesSearch(newCovMatrix);
