 ...
 */
public class PcdSearch implements GraphSearch {
    ...
    public PcdSearch(IndependenceTest independenceTest, Knowledge knowledge) {
	...
	public Graph search() {
        ...
        FastAdjacencyDeterministic fas =
                new FastAdjacencyDeterministic(graph, getIndependenceTest());
