...
public class BinaryFunction {
    ...
    /**
     * Constructs a binary function by giving the number of arguments and the
     * function index, from which the function column will be calculated.
     *
     * @param numArgs       The number of arguments to the function. The order
     *                      of these is T-F, left to right in increasing period
     *                      of alternation.
     * @param functionIndex Represents the function column of the truth table.
     *                      Should be a number from 0 to 2 ^ numArgs - 1. The
     *                      value for a given row in the truth table is
     *                      calculated by the getValue() method.
     */
