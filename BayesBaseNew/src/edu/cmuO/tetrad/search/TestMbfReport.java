...
//            String variableType = "Discrete";
            ...
            String fileOutName = "test_data/mbfsreport_"
                    + nf.format(alpha) + "_" +
                    + dimension + "_"
                    + sampleSize + "_" +
                    + depth + "_" +
...
//    }
    ...
    private void examineContinuousDatabase(int numTargets, int dimension,
        ...
        Dag randomGraph = GraphUtils.createRandomDag(dimension, 0, dimension,
                40, 40, 40, false);
        ...
        IndependenceTest test = new IndTestFisherZD(dataSet, alpha);
