 ...
 * @version $Revision: 4610 $ $Date: 2006-01-20 13:34:55 -0500 (Fri, 20 Jan
 *          2006) $
 */
public final class CeFanSearchSepset {
     ...
     */
    private int stopPoint = CeFanSearchSepset.TRIMMED_ORIENTED_ADJACENCY_GRAPH;
     ...
     */
    public CeFanSearchSepset(IndependenceTest test, int depth) {
        if (test == null) {
...
//        orientation.doImpliedOrientations(graph);
        ...
        if (getStopPoint() == CeFanSearchSepset.UNTRIMMED_ORIENTED_ADJACENCY_GRAPH) {
            finishUp(start, graph);
            return graph;
        }
...
//        System.out.println("MB fan search took " + nf.format(seconds) + " seconds.");
    ...
    public void setStopPoint(int stopPoint) {
        switch (stopPoint) {
            case CeFanSearchSepset.UNTRIMMED_UNORIENTED_ADJACENCY_GRAPH:
            case CeFanSearchSepset.UNTRIMMED_ORIENTED_ADJACENCY_GRAPH:
            case CeFanSearchSepset.TRIMMED_ORIENTED_ADJACENCY_GRAPH:
                break;
            default:
...
//        List<Node> nodes = graph.getNodes();
    ...
    public static void orientUsingMeekRulesLocally(Knowledge knowledge,
        ...
        while (true) {
            if (CeFanSearchSepset.meekR1Locally(graph, knowledge, test, depth, neighborhood)) {
                continue;
            }

            if (CeFanSearchSepset.meekR2(graph, knowledge, neighborhood)) {
                continue;
            }

            if (CeFanSearchSepset.meekR3(graph, knowledge, neighborhood)) {
                continue;
            }

            if (CeFanSearchSepset.meekR4(graph, knowledge, neighborhood)) {
                continue;
            }
            ...
            for (Node a : neighborhood) {
                ...
                while ((combination = cg.next()) != null) {
                    ...
                    if (graph.getEndpoint(b, a) == Endpoint.ARROW &&
                        ...
                        if (CeFanSearchSepset.isArrowpointAllowed(a, c, knowledge)) {
                        ...
                        if (CeFanSearchSepset.isArrowpointAllowed(a, b, knowledge)) {
        ...
        for (Node a : neighborhood) {
            ...
            while ((combination = cg.next()) != null) {
                ...
                if (graph.isDirectedFromTo(b, a) &&
                    ...
                    if (CeFanSearchSepset.isArrowpointAllowed(b, c, knowledge)) {
                    ...
                    if (CeFanSearchSepset.isArrowpointAllowed(c, b, knowledge)) {
...
//                    }
                    ...
                    if (graph.isDirectedFromTo(b, c) &&
                        ...
                        if (CeFanSearchSepset.isArrowpointAllowed(a, d, knowledge)) {
