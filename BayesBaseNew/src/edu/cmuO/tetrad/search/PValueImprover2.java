...
public final class PValueImprover2 {
    ...
    public PValueImprover2(SemIm semIm, RectangularDataSet data, Knowledge knowledge) {
        this.semIm = semIm;
        this.dataSet = data;
        this.knowledge = knowledge;
    }

    public PValueImprover2(RectangularDataSet data, Knowledge knowledge) {
        this.dataSet = data;
        this.knowledge = knowledge;
    }
...
//        return new Score(estimatedSem, -estimatedSem.getFml());
     ...
     * @version $Revision: 6151 $ $Date: 2005-07-06 13:39:56 -0400 (Wed, 06 Jul
     *          2005) $
     */
