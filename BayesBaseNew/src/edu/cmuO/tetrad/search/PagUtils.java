...
/**
 * This class contains methods which can be used to determine whether a directed
 * graph is in the equivalence class determined by the given PAG.  See p. 300
 * Def. 12.1.1 of CPS for a specification.
 *
...
public final class PagUtils {
     ...
     */
    public static boolean graphInPagStep1(Pag pag, Graph dag) {
    ...
    public static boolean graphInPagStep2(Pag pag, Graph dag) {
...
//                Node[] arrayOMinusAB = OMinusAB.toArray(new Node[0]);
    ...
    public static boolean graphInPagStep3(Pag pag, Graph dag) {
    ...
    public static boolean graphInPagStep4(Pag pag, Graph dag) {
        List<Edge> pagEdges = pag.getEdges();
    ...
    public static boolean graphInPagStep5(Pag pag, Graph dag) {
        List<Triple> pagUnderLines = pag.getUnderLineTriples();
    ...
    public static boolean graphInPagStep6(Pag pag, Graph dag) {
        List<Node> pagNodes = pag.getNodes();
        List<Node> dagNodes = dag.getNodes();

        List<Triple> pagDottedUnderlines = pag.getDottedUnderLineTriples();
