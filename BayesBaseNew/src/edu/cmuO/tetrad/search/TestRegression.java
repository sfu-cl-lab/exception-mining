...
public class TestRegression extends TestCase {
    ...
    public void testTabular() {
        RectangularDataSet data = loadCarsFile();
        ...
        Regression regression = new RegressionDatasetGeneralized(data);
...
//        RegressionNew regression = new RegressionTabular(data);
    ...
    public void testTabular2() {
        RectangularDataSet data = loadRegressionDataFile();
    ...
    private DoubleMatrix1D calculateMeans(Node target, RectangularDataSet data) {
    ...
    private double[] getArray(RectangularDataSet data, Node node) {
    ...
    private RectangularDataSet loadCarsFile() {
        ...
        RectangularDataSet data = parser.parseTabular(chars);
        return data;
    }

    private RectangularDataSet loadRegressionDataFile() {
