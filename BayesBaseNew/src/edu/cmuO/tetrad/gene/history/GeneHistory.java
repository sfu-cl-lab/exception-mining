 ...
 * @version $Revision: 5177 $ $Date: 2006-01-08 23:44:17 -0500 (Sun, 08 Jan
 *          2006) $
 */
public class GeneHistory implements TetradSerializable {
    ...
    /**
     * The current time step, which is the number of steps <i>after</i> the
     ...
     * from maxlag up to 0, the current time step). Note that the firs subscript
    ...
    /**
     * Returns the current history array.  In the array, historyArray[0]
     * represents the current time step, historyArray[1] the time step one lag
     ...
     *
     * @return the current value of <code>initSync</code>.
     */
