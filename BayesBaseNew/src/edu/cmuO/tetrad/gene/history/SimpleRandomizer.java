	...
	public void initialize(LagGraph lagGraph) {
        ...
        for (Iterator it = factors.iterator(); it.hasNext();) {
            ...
            boolean isHousekeeping =
                    PersistentRandomUtil.getInstance().nextDouble() * 100 < this
                            .percentHousekeeping;
            ...
            switch (indegreeType) {
                ...
                case MAX:
                    extraEdges = PersistentRandomUtil.getInstance().nextInt(
                            indegree - 1) + 1;
                    break;
            ...
            while (i < extraEdges) {
                ...
                int lag = PersistentRandomUtil.getInstance().nextInt(
                        this.mlag) + 1;

                // Pick a factor uniformly from {0, ..., numfactors}.
                int factorIndex = PersistentRandomUtil.getInstance().nextInt(
