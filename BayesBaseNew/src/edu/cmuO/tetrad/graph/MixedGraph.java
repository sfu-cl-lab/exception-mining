...
public final class MixedGraph implements TetradSerializable, Graph {
    ...
    /**
     * Constructs a new black MixedGraph.
     */
    public MixedGraph() {
    ...
    /**
     * Constructs a new MixedGraph based on the given graph.
     *
     * @param graph the graph which the new MixedGraph is to be based on.
     * @throws IllegalArgumentException if the given graph cannot for some
     *                                  reason be converted into a MixedGraph.
     */
    public MixedGraph(Graph graph) throws IllegalArgumentException {
        List<GraphConstraint> constraints1 = Arrays.asList(constraints);
        for (Object aConstraints1 : constraints1) {
            addGraphConstraint((GraphConstraint) aConstraints1);
        }
     ...
     */
    public static MixedGraph serializableInstance() {
