...
public class UniformDistribution implements Distribution {
     ...
     */
    public static UniformDistribution serializableInstance() {
    ...
    public Uniform getUniform() {
        if (uniform == null) {
            uniform = new Uniform(a, b, PersistentRandomUtil.getInstance().getRandomEngine());
        }
