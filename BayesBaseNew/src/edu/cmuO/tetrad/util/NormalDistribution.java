...
public class NormalDistribution implements Distribution {
    ...
    public NormalDistribution(double mean, double sd) {
        normal = new Normal(mean, stDev, PersistentRandomUtil.getInstance().getRandomEngine());
        setParameter(0, mean);
        setParameter(1, sd);
    }
     ...
     */
    public static NormalDistribution serializableInstance() {
	...
	public String toString() {
        ...
        return "N(" + nf.format(mean) + ", " + nf.format(stDev) + ")";
    }
