...
public final class Parameter implements TetradSerializable {
     ...
     * @param nodeB The "to" node. (For variance parameters, this must be the
     *              same as the "from" node. For covariance parameters, it must
	...
	public String toString() {
        return "<" + this.name + ", " + this.type + ", " + this.nodeA + ", " +
                this.nodeB + ", " + this.fixed + ">" /*+ super.toString() */;
    }
     ...
     *
     * @see edu.cmu.tetrad.util.SingleValue
     */
