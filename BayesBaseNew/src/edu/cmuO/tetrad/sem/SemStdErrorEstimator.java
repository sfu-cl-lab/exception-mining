...
/**
 * <p>Includes methods for estimating the standard errors of the parameters of
...
public class SemStdErrorEstimator {
    ...
    /**
     * The array in which the standard errors of the parameters are stored.
     */
...
//    private SemIm semIm;
     ...
     * 135 of Bollen) with respect to the free parameters of the estimated SEM.
     * It then computes the inverse of the the information matrix and calculates
     * the standard errors of the parameters as the square roots of the diagonal
     * elements of that matrix.</p>
     *
     * @param estSem the estimated SEM.
     */
    public void computeStdErrors(SemIm estSem) {
...
//        this.semIm = estSem;
        ...
        //Store the free parameters of the SemIm so that they can be reset to these
        ...
        for (int i = 0; i < n; i++) {
            for (int j = i; j < n; j++) {
                ...
                if (!containsCovararianceParameter) {
                    ...
                    // Restrict off-diagonal to just collider edge parameters.
...
//            System.out.println("Zero row for " + freeParameters.get(i));
        ...
        //squares of the standard errors of the parameters.  Their order is the
        //same as in the array of free parameter values stored in paramsOriginal.
        try {
            DoubleMatrix2D hessInv = new Algebra().inverse(hess);
...
//            }
            ...
            //Hence the standard errors of the parameters are the square roots of the
...
//                }
        ...
        //Restore the parameters of the estimated SEM to their original values.
...
//        }
     ...
     * @version $Revision: 6162 $ $Date: 2005-07-06 13:39:56 -0400 (Wed, 06 Jul
     *          2005) $
     */
