 ...
 * @version $Revision: 4529 $ $Date: 2006-01-19 17:54:39 -0500 (Thu, 19 Jan
 *          2006) $
 */
...
public class Tsls {
     ...
     * variables.
     */
    public Tsls(SemPm spm, RectangularDataSet dataSet, String nm) {
    ...
    private void initialization(SemPm spm, RectangularDataSet dataSet,
            String nm) {
...
//                    Z[j][i] = column_data[j];
            ...
            // measurement associated with the only latent parent of the current
...
//            double C[] = (double[]) column.getRawData();
            ...
            // associated with the parents of the (latent) parent of current
            ...
            // the other measurements attached to the parent of the current node,
            // assuming that the error term of the current node is independent
...
//            System.arraycopy(rawData, 0, yi, 0, n);
            ...
            // Set the edge for the current measurement
