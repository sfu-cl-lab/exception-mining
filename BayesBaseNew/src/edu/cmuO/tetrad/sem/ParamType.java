...
/**
 * A typesafe enum of the types of the types of parameters for SEM models (COEF,
 * MEAN, VAR, COVAR). COEF parameters are edge coefficients in the linear SEM
 * model; VAR parmaeters are variances among the error terms; COVAR parameters
 * are (non-variance) covariances among the error terms.
 *
 * @author Joseph Ramsey
 * @version $Revision: 5814 $ $Date: 2005-09-22 15:28:56 -0400 (Thu, 22 Sep
 *          2005) $
 */
