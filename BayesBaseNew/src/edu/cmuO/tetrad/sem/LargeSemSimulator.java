 ...
 * @version $Revision: 5676 $ $Date: 2006-01-20 13:34:55 -0500 (Fri, 20 Jan
 *          2006) $
 */
public final class LargeSemSimulator {
    ...
    public LargeSemSimulator(Dag graph) {
        ...
        Distribution edgeCoefDist = new SplitDistribution(0.5, 1.5);
        Distribution errorCovarDist = new UniformDistribution(1.0, 3.0);
        Distribution meanDist = new NormalDistribution(-1.0, 1.0);
...
//        }
     ...
     */
    public RectangularDataSet simulateDataAcyclic(int sampleSize) {
...
//        System.out.println("Creating data set.");
    ...
    public RectangularDataSet simulateDataAcyclic(RectangularDataSet dataSet) {
        List<Node> variables = new LinkedList<Node>();
        List<Node> variableNodes = getVariableNodes();
