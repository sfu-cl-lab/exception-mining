...
public final class Knowledge implements TetradSerializable {
    ...
    public Knowledge(Knowledge knowledge) {
        ...
        this.forbiddenEdges =
                new HashSet<KnowledgeEdge>(knowledge.forbiddenEdges);
    ...
    public final Iterator<KnowledgeEdge> forbiddenEdgesIterator() {
        return Collections.unmodifiableSet(forbiddenEdges).iterator();
    }
     ...
     */
    public final List<String> getVarsNotInTier(List<String> varNames) {
        List<String> notInTier = new ArrayList<String>(varNames);
    ...
    public final boolean edgeExplicitlyRequired(String var1, String var2){
        return this.requiredEdges.contains(new KnowledgeEdge(var2, var2));
    }
    ...
    public final boolean edgeForbidden(String var1, String var2) {
        ...
        return forbiddenEdges.contains(edge);
    }
    ...
    public final boolean noEdgeRequired(String x, String y) {
        return !(isCommonCauseRequired(x, y) || edgeRequired(x, y) ||
                edgeRequired(y, x));
    }
    ...
    public final boolean isEmpty() {
        return this.allRequiredEdges.isEmpty() && forbiddenEdges.isEmpty() &&
     ...
     * </pre>
     */
    public static void saveKnowledge(Knowledge knowledge, Writer out)
            throws IOException {
     ...
     */
    public final void setEdgeForbidden(String var1, String var2,
                                       boolean forbid) {
        if (forbid) {
            if (edgeForbidden(var1, var2)) {
                return;
            }
            ...
            if (isForbiddenByTiers(var1, var2)) {
                throw new IllegalStateException("The edge " + var1 + "-->" +
                        var2 +
                        " is forbidden by tiers. Please adjust tiers first.");
            }
     ...
     */
    public final void setEdgeRequired(String var1, String var2,
                                      boolean required) {
        if (required) {
            if (isForbiddenByTiers(var1, var2)) {
                throw new IllegalArgumentException("The edge " + var1 +
                        " --> " + var2 +  " is forbidden by temporal tiers. Please adjust tiers first.");
            }
	...
	public final int hashCode() {
        ...
        hash += 17 * this.forbiddenEdges.hashCode() + 37;
        ...
        hash += 17 * Boolean.valueOf(this.defaultToKnowledgeLayout).hashCode() +
                37;
        return hash;
    }
	...
	public final boolean equals(Object o) {
        ...
        if (!(this.forbiddenEdges.equals(knowledge.forbiddenEdges))) {
            return false;
        }
	...
	public final String toString() {
        ...
        for (Iterator<KnowledgeEdge> it =
                requiredEdgesIterator(); it.hasNext();) {
            KnowledgeEdge o = it.next();
            buf.append("\n\t").append(o.getFrom()).append("-->").append(
                    o.getTo());
        }
        ...
        for (Iterator<KnowledgeEdge> it =
                forbiddenEdgesIterator(); it.hasNext();) {
            KnowledgeEdge o = it.next();
            buf.append("\n\t").append(o.getFrom()).append("-->").append(
                    o.getTo());
        }
    ...
    private void clearExplicitKnowledge() {
        ...
        forbiddenEdges = new HashSet<KnowledgeEdge>();
    ...
    private void generateForbiddenEdgeList() {
        ...
        forbiddenEdges.addAll(explicitlyForbiddenEdges);
    }
