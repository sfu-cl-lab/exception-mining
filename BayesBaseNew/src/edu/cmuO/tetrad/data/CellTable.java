...
import edu.cmu.tetrad.util.IMultiDimIntTable;
import edu.cmu.tetrad.util.MultiDimIntTable2;
 ...
 * @version $Revision: 6039 $ $Date: 2006-01-09 11:04:56 -0500 (Mon, 09 Jan
 *          2006) $
...
public final class CellTable {
    ...
    private IMultiDimIntTable table;
...
//        this.table = new MultiDimIntTable(dims);
        this.table = new MultiDimIntTable2(dims);
    }

    public final void addToTable(RectangularDataSet dataSet, int[] indices) {
