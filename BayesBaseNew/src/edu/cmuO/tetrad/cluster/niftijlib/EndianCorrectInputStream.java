package edu.cmu.tetrad.cluster.niftijlib;
...
public class EndianCorrectInputStream extends DataInputStream {
     ...
     * @param be       -- endian flag: if be (big endian) is false bytes will be
     *                 flipped on read
    ...
    public float readFloatCorrect() throws IOException {
        ...
        if (bigendian) {
            ...
            x |= (readUnsignedByte()) << 8;
            x |= (readUnsignedByte()) << 16;
            x |= (readUnsignedByte()) << 24;
