...
//        searchClasses.add(PcxRunner.class);
        searchClasses.add(MbFanSearchRunner.class);
...
//        getEditorMap().put(CorrMatrixConverter.class, DataEditor.class);
        ...
        getEditorMap().put(MbFanSearchRunner.class, MbSearchEditor.class);
...
//                PcSearchParams.class);
        ...
        getParamsMap().put(MbFanSearchRunner.class, null, MbSearchParams.class);
...
//        getParamsMap().put(GaRunner.class, GaParams.class);
    ...
    private void initializeDescripMap() {
        ...
        getDescripMap().put(EmBayesEstimatorWrapper.class,
                "EM Bayes Estimator");
        // getDescripMap().put(EmBayesEstimatorWrapper.class, "DVD");
...
//                "Local Orientation");
        ...
        getDescripMap().put(MbFanSearchRunner.class, "MBFS");
...
//        getAcronymMap().put(LocalOrientationTestRunner.class, "LO");
        ...
        getAcronymMap().put(MbFanSearchRunner.class, "MBF");
...
//                "correlation_matrix_converter");
        ...
        getHelpNameMap().put(MbFanSearchRunner.class, "mbf");
