 ...
 * @version $Revision: 6379 $ $Date: 2005-08-30 16:29:17 -0400 (Tue, 30 Aug
 *          2005) $
 */
public class SemEstimatorWrapper implements SessionModel, GraphSource {
     ...
     * jdramsey 8/29/07
     */
    private SemEstimatorWrapper(RectangularDataSet dataSet, SemPm semPm) {
    ...
    public static SemEstimatorWrapper serializableInstance() {
        RectangularDataSet dataSet = DataUtils.continuousSerializableInstance();
