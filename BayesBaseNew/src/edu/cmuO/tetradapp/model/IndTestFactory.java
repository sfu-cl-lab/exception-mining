 ...
 * @version $Revision: 6408 $ $Date: 2006-01-19 17:54:39 -0500 (Thu, 19 Jan
 *          2006) $
 */
public final class IndTestFactory {
    ...
    public IndependenceTest getTest(Object dataSource, SearchParams params,
        ...
        if (dataSource instanceof RectangularDataSet) {
            RectangularDataSet dataSet = (RectangularDataSet) dataSource;

            if (dataSet.isContinuous() || dataSet.getNumColumns() == 0) {
                RectangularDataSet dataContinuous =
                        (RectangularDataSet) dataSource;
            ...
            if (dataSet.isDiscrete()) {
                RectangularDataSet dataDiscrete =
                        (RectangularDataSet) dataSource;
...
//        }
    ...
    private IndependenceTest getContinuousTest(RectangularDataSet dataSet,
        ...
        if (IndTestType.LINEAR_REGRESSION == testType) {
            return new IndTestLinearRegression(dataSet,
    ...
    private IndependenceTest getDiscreteTest(RectangularDataSet dataDiscrete,
            SearchParams params, IndTestType testType) {
        IndTestParams indTestParams = params.getIndTestParams();
