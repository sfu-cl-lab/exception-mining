 ...
 *          2005) $
 */
public class LagIndTestParams implements IndTestParams {
    ...
    /**
     * @serial Range [1, numTimePoints - 1].
     */
    ...
    public void setNumLags(int numLags) {
        if (numLags < 1 || numLags > getNumTimePoints() - 1) {
    ...
    public void setNumTimePoints(int numTimePoints) {
        if (numTimePoints < 2) {
            throw new IllegalArgumentException(
                    "NumTimePoints out of range: " + numTimePoints);
        }
