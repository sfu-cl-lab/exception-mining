 ...
 * @version $Revision: 4338 $ $Date: 2005-11-29 16:02:50 -0500 (Tue, 29 Nov
 *          2005) $
 * @deprecated Use BootstrapSamplerWrapper instead.
 */
@Deprecated
public class DiscreteBootstrapSamplerWrapper extends DataWrapper {
    ...
    public DiscreteBootstrapSamplerWrapper(DataWrapper wrapper,
            DiscreteBootstrapSamplerParams params) {
        if (wrapper == null) {
    ...
    public static DataWrapper serializableInstance() {
        return new DiscreteBootstrapSamplerWrapper(
                DataWrapper.serializableInstance(),
                DiscreteBootstrapSamplerParams.serializableInstance());
    }
