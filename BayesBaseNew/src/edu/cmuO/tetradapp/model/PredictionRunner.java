...
/**
 * @author Erin Korber
 * @version $Revision: 4524 $ $Date: 2005-07-26 16:13:15 -0400 (Tue, 26 Jul
 *          2005) $
 */
public class PredictionRunner implements SessionModel {
    ...
    public PredictionRunner(Pag pag, RectangularDataSet dataSet) {
        if (pag == null) {
    ...
    public PredictionRunner(FciRunner f, DataWrapper w) {
        this(new Pag(f.getResultGraph()),
                (RectangularDataSet) w.getSelectedDataModel());
    }
    ...
    public static PredictionRunner serializableInstance() {
        return new PredictionRunner(Pag.serializableInstance(),
