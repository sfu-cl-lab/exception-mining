 ...
 * @version $Revision: 6039 $ $Date: 2005-07-28 12:28:31 -0400 (Thu, 28 Jul
 *          2005) $
 */
public class MimBuildRunner extends AbstractMimRunner implements GraphSource {
    ...
    public static MimBuildRunner serializableInstance() {
        RectangularDataSet dataSet = DataUtils.discreteSerializableInstance();
    ...
    private IndTestMimBuild getIndependenceTest() {
        if (getData() instanceof RectangularDataSet) {
            RectangularDataSet dataContinuous = (RectangularDataSet) getData();
