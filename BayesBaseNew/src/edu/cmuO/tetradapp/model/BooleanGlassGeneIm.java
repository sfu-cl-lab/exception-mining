...
import edu.cmu.tetrad.gene.graph.DisplayNameHandler;
...
public class BooleanGlassGeneIm implements SessionModel {
     ...
     *               is extracted.
     */
    public BooleanGlassGeneIm(BooleanGlassGenePm genePm) {
        try {
            this.genePm = genePm;
            ...
            this.simulator = new MeasurementSimulatorParams();
        }
        catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static BooleanGlassGeneIm serializableInstance() {
        return new BooleanGlassGeneIm(
                BooleanGlassGenePm.serializableInstance());
    }
    ...
    public DataModel simulateData() {
        ...
        RectangularDataSet measuredDataSet =
...
//        System.out.println(measuredDataSet);
    ...
    private TimeSeriesData asTimeSeriesData(double[][][] cube, int cell,
        ...
        return new TimeSeriesData(new DenseDoubleMatrix2D(square), varNames);
    }
