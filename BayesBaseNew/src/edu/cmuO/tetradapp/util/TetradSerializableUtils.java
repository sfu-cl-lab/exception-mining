 ...
 * @version $Revision: 6556 $ $Date: 2006-01-06 22:37:50 -0500 (Fri, 06 Jan
 *          2006) $
...
public class TetradSerializableUtils {
     ...
     */
    public static final Class[] safelySerializableTypes = new Class[]{
            String.class, Class.class, Date.class, Collection.class, Map.class,
            DoubleMatrix2D.class, Document.class, Normal.class, Uniform.class,
            BreitWigner.class, Beta.class, DoubleMatrix1D.class
    };
    ...
    /**
     * Blank constructor. Please set the directory paths that you will need
    ...
    public void serializeCurrentDirectory() throws RuntimeException {
        ...
        for (Object aClass : classes) {
            ...
            if (serializableInstanceMethod(clazz) == null) {
    ...
    private void serializeClass(Class clazz,
        ...
        try {
            ...
            if (!_static || !_final || !(23L == field.getLong(null))) {
                throw new RuntimeException(
                        "Class does not define static final " +
                                "long serialVersionUID = 23L");
            }

            Method method =
                    clazz.getMethod("serializableInstance", new Class[0]);
    ...
    public Object deserializeClass(File file) throws RuntimeException {
        try {
            ...
            throw new RuntimeException("There is no class in the current API " +
    ...
    public void updateVersion() {
        try {
            ...
            if (!file.exists()) {
                throw new RuntimeException(
                        "Please make a file project/resources/version " +
                                "with a version number the form a.b.c-d in it, where a, b, " +
    ...
    public void deserializeArchivedVersions() throws RuntimeException {
        ...
        for (String archiveName : listing) {
            ...
            try {
                ...
                throw new RuntimeException(
                        "Could not read class_fields.ser " + " in archive.", e);
            }
            catch (IOException e) {
