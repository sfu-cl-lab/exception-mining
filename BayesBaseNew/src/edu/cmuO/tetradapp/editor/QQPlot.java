...
import edu.cmu.tetrad.search.Exponential;
import edu.cmu.tetrad.search.Gaussian;
...
public class QQPlot {
     ...
     * @param selectedNode
     */
    public QQPlot(RectangularDataSet dataSet, Node selectedNode) {
    ...
    private void testPlot()
    {
        ...
        {
            double value = g.drawSample();
            double value2 = e.drawSample();
     ...
     */
    public void calculateComparisonSet(Normal n, RectangularDataSet data)
    {
