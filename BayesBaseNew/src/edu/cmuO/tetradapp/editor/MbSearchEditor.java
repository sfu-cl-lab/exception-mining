 ...
 * @version $Revision: 6533 $ $Date: 2006-01-20 13:34:55 -0500 (Fri, 20 Jan
 *          2006) $
 */
public class MbSearchEditor extends AbstractSearchEditor
     ...
     */
    public MbSearchEditor(PcxRunner runner) {
        super(runner, "Result MB DAG");
    }
    ...
    public MbSearchEditor(MmmbRunner runner) {
        super(runner, "Result MB Nodes");
    }

    public MbSearchEditor(HitonRunner runner) {
        super(runner, "Result MB Nodes");
    }
...
//        }
        ...
        if (getAlgorithmRunner() instanceof MbFanSearchRunner) {
...
//            graph.addSeparator();
            ...
            showDags.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
                    ...
                    if (!(runner instanceof MbFanSearchRunner)) {
                        return;
                    }

                    MbFanSearchRunner mbRunner = (MbFanSearchRunner) runner;
                    final MbFanSearch search = mbRunner.getMbFanSearch();
