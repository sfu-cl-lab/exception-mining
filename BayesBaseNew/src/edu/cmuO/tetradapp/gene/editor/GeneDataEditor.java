 ...
 * @version $Revision: 6038 $ $Date: 2006-01-20 13:34:55 -0500 (Fri, 20 Jan
 *          2006) $
...
public class GeneDataEditor extends JPanel implements PropertyChangeListener {
    ...
    private void constructTabbedPane() {
        ...
        for (int index = 0; index < getDataModelList().size(); index++) {
            DataModel dataModel = getDataModelList().get(index);
...
class GeneDataEditorMenuBar extends JMenuBar {
    ...
    private void saveDataSetData() {
        File file = EditorUtils.getSaveFile("data", "dat", editor, false);
        ...
        RectangularDataSet dataSet =
                (RectangularDataSet) editor.getSelectedDataSet();
